            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @include('alerts')
                        <form method="post" action="{{url('student/editstudent/'.$user->studentid)}}">
                            {{csrf_field()}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    ...
                                    <input class="form-control" type="text" value="{{$user->frisrtname}}"  name="frisrtname" id="frisrtname" class="frisrtname">
